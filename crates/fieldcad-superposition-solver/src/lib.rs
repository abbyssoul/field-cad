...
use fieldcad_superposition::{
    ...
    InverseSquareSource, field_excluding_at,
};
...
mod tests {
    ...
    fn point(strength: f64, position: DVec3) -> InverseSquareSource {
        InverseSquareSource {
            position,
            strength,
            distribution: fieldcad_core::ChargeDistribution::Point {
    ...
    fn add_forces_excluding_into_matches_the_per_body_path_bit_for_bit() {
        let sources = [
            ...
            InverseSquareSource {
                ...
                strength: 2.0,
                distribution: fieldcad_core::ChargeDistribution::UniformSphere { radius: 1.5 },
            },
        ];
        let bodies = [
            (Some(0), DVec3::ZERO),
